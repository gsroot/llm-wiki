...
# GitHub c2spf-gsroot — 레포 인덱스

`c2spf-gsroot`는 내가 회사에서 수행한 프로젝트 저장소를 모아 둔 GitHub 조직입니다. 이 문서는 <https://github.com/c2spf-gsroot>에 있는 회사 프로젝트 레포지토리의 **공개 인덱스**입니다.
...
- 📊 **총 커밋 (내 기여분)**: **1,349 커밋** across 6개 레포 (2019~2026)
...
|------|---------|------------------|----------|-------------|------|
| [analytics-frontend](./repos/analytics-frontend.md) | JavaScript / TypeScript | **710** / 2,673 | 2025-04 ~ 현재 | [React 리뉴얼](../../../20-projects/com2us-platform/) | ✅ |
| [analytics-common-api](./repos/analytics-common-api.md) | Python | **235** / 261 | 2024-09 ~ 현재 | [공통 모듈](../../../20-projects/com2us-platform/) | ✅ |
...
- 📦 **전체 레포**: 6개 (회사에서 수행한 프로젝트 저장소)
- ✍️ **내 커밋**: **1,349개** (전체 5,003 커밋의 27.0%)
- 📆 **기여 기간**: 2019-03 ~ 2026-06 (약 7년)
- 🥇 **가장 많이 기여한 레포**: `analytics-frontend` (710 커밋, 리드 역할)
...
- **커밋 집계 기준**: `김석근 <sgkim@com2us.com>` author 기준. 과거 `gsr2732@gmail.com` 커밋은 히스토리 정리 후 동일 identity로 통합됨
