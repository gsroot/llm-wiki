...
본 페이지는 **stub** — ASF 자체가 raw 수집 대상이 아닌 상태에서 [[kafka]] / [[parquet]] / [[pyarrow]] / dataframe-ecosystem-evolution 종합이 거버넌스 모델로 참조하므로 정합성 stub으로 등록.
...
- [[dataframe-ecosystem-evolution]] 핵심 결론
...
| 본 위키 사례 | [[kafka]] / [[parquet]] / [[pyarrow]] | [[prometheus]] |
| 시점 | 16 | 21 (=19) |
...
- stub 사유: 점검에서 `[[apache-foundation]]` 깨진 링크 발견. 기존 Apache Kafka/Arrow source 기반으로 1차 보강.
