...
type: entity
entity_type: tool
tags: [sentry, error-tracking, observability, agents-md, anti-fragmentation, viewer-context]
...
Sentry는 David Cramer(2008, Disqus 사내 프로젝트)가 만든 developer-first 에러 트래킹/성능 모니터링 플랫폼. Functional Software, Inc.가 운영하며 Django + React 모노레포다. 발견된 가장 강력한 **반-fragmentation AGENTS.md SSOT** 사례 — "AGENTS.md is the source of truth, do not add to CLAUDE.md or Cursor rules"를 명문화한 첫 OSS.
