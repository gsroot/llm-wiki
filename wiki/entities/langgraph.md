...
[[seokgeun-stack-guide|석근 32 OSS 스택 카탈로그]] stateful agent 프레임워크 영역. [[matechat|MateChat 사이드 프로젝트]] 채팅 분석 모듈의 multi-step orchestration 후보. [[langchain]] 산하 + [[deepagents]]가 LangGraph Native로 빌드. **상태 기반 그래프 + durable execution** 패턴은 [[llm-infra-meta-cluster|LLM 인프라 메타 5축]] 5축의 [[harness]] 진화 사례 — [[crewai]]·[[pydantic-ai]]와 함께 6 프레임워크 매트릭스 비교됨([[agent-frameworks-matrix]]).
