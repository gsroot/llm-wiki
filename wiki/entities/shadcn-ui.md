...
[[seokgeun-stack-guide]]에서 React UI 컴포넌트 표준. **Open Code 패러다임**(코드 분배 vs npm 분배)이 22회차 위키의 10번째 OSS 거버넌스 모델로 발견됨. [[radix-ui]](headless primitives) + [[tailwindcss]] 위에 빌드. shadcn 단일 메인테이너.
