...
DuckDB는 **인프로세스 임베디드 OLAP 데이터베이스** — "분석용 SQLite"로 자주 표현된다. 2018년 Hannes Mühleisen + Mark Raasveldt(네덜란드 CWI)가 시작, 2024년 v1.0, 2026년 v1.x stable. **단일 바이너리, 서버 없음, SQL OLAP**이라는 미발견 슬롯을 차지한 도구.
