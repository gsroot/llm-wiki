...
[[seokgeun-stack-guide]] Python 백엔드 5단의 캐시·실시간 축. [[matechat]] WebSocket 세션·실시간 알림 채택 + [[c2spf-analytics]] 캐시 후보. **MANIFESTO 10항목**은 [[postgresql]] 메일링 리스트 거버넌스·[[bdfl]]과 함께 [[llm-infra-meta-cluster]] 5축의 거버넌스 다양성 6번째 모델 — opinionated 디자인 철학의 명문화 사례. 2024 라이선스 변경 → Valkey fork 분기.
