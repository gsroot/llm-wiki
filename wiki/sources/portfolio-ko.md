...
- **Impact 표** — 개발 경력 9년, c2spf 기여 1,349커밋, 공통 API 90.0% ownership, 프론트엔드 생산성 30~40% 향상 기반, 블록체인 프로젝트 5건(가스비 ~90% 절감 포함). 모든 수치는 `10-sources/*/INDEX.md`로 역링크.
- **Selected Work 5선**
 1. 애널리틱스 React 리뉴얼 (2025.06–) — `analytics-frontend` 710커밋, Vite/TS/TanStack/Zustand/ag-grid 스택 표준화, 2025 FE 가이드라인 문서화, GCPPDT-741/742 Story MR, 회귀 테스트 32/32·22/22 통과, 측정값 에러 8종 × 5개 로케일 i18n.
 ...
 3. 애널리틱스 공통 모듈 & 배포 (2024.08–) — `analytics-common-api` 235/261(90.0%), HIVE OAuth 8엔드포인트, Docker Compose + Jenkins 멀티브랜치, Promtail/Loki/Grafana 4환경, 배포/운영 가이드 4종 2024-10 집중 발행.
