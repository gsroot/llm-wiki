...
1. **[[anthropics-skills]]** (3회차, 2025) — 표준 정의 (정적 SKILL.md 패키지)
2. **[[github-spec-kit]]** (7회차, 2025) — Codex Skills 외부 도구 통합 (메소드론 어댑터)
3. **[[fastapi-fastapi]]** (9회차, 2025) — 라이브러리 self-hosted SKILL.md (정적 컨벤션)
4. **[[astral-sh-uv]]** (10회차, 2025) — `CLAUDE.md → AGENTS.md` 듀얼 지침서 (정적 single source)
5. **[[scikit-learn]]** (11회차, 2025) — AI disclosure 강제 (정적 거버넌스)
6. **[[flutter-flutter]]** (12회차, 2025) — vendor-neutral `.agents/skills/` (정적 자산)
7. **본 회차 (13회차, 2026)** — **살아있는 AGENTS.md** (Recent Learnings 운영 노트)
...
- **AGENTS.md "Recent Learnings" 본 위키 차용**: 본 위키 자체에 `wiki/AGENTS.md` (또는 CLAUDE.md 보강)에 "Recent Learnings" 섹션을 신설하고, 매 회차 ingest에서 발견된 함정·솔루션을 누적. 13회차 누적 시 위키 운영 자체의 메타 메모.
