...
> 위키 인바운드 측정 결과, [[agent-skills]](58) / [[harness]](49) / [[mcp]](36) / [[claude-code]](36) 4개 메타 개념이 인바운드 1·2·5·6위(합산 179)를 점유. 이는 4핵심축([[seokgeun-kim|프로필]] / [[portfolio-seed|포트폴리오]] / [[seokgeun-stack-guide|기술 스택]] / [[matechat|MateChat]])보다 더 큰 무게중심이며, 본 페이지는 이 **숨은 5번째 축**을 명시화하고 그 진화 단계·OSS 채택 매트릭스를 한 곳에 모아 RAG와 Obsidian 양쪽에서 단일 진입점을 제공한다.
...
→ 4축이 **"무엇이 있는가"**라면, 5축은 **"어떻게 운영되는가"**. 즉 5축은 다른 4축을 가로지르는 직교 layer.
...
- 본 페이지가 인바운드 5+ 도달 시 (현재 0, 신규) 본 위키가 "메타 거버넌스 시스템"으로 진화한 직접 증거가 된다.
