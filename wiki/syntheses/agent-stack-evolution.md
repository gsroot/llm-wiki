...
| **OpenAI (cookbook)** | **살아있는 운영 노트 + 7시간+ 단일 작업 living document** | openai-cookbook `AGENTS.md` Recent Learnings + `articles/codex_exec_plans.md` PLANS.md + registry.yaml | **정적 가이드의 동적 진화** (정적 표준의 6 사례에서 처음으로 운영 중 발견을 즉시 반영하는 모드) |
...
- [[openai-openai-cookbook]] — OpenAI ★73K 4년차 cookbook의 `AGENTS.md` Recent Learnings 살아있는 운영 노트 + `articles/codex_exec_plans.md` PLANS.md / ExecPlans + `registry.yaml` 콘텐츠 거버넌스 자동화. **6번째 축 (정적 가이드 → 살아있는 운영 노트)**
