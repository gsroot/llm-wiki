...
- 개념: 39 (rcif-prompt-pattern, chain-of-thought-prompting, progressive-disclosure, vendor-neutral, annotated-pattern, api-response-envelope, time-series-processing 신설 2026-04-30 — 다중 Phase audit. 거버넌스 도입 후 누적 신설 7개)
...
| [[annotated-pattern]] | Annotated 패턴 (PEP 593) — Type-First Python의 단일 표현 | annotated-pattern, pep-593, python, type-hints, pydantic, fastapi, sqlalchemy, typer, 백엔드, type-first-python | 4 | 2026-04-30 |
| [[api-response-envelope]] | API Response Envelope (result_code · message · data 표준) | api-response-envelope, api-design, fastapi, 백엔드, response-pattern, error-handling | 4 | 2026-04-30 |
| [[time-series-processing]] | 시계열 처리 (Time Series Processing) — 저장 · 알고리즘 · 관측성 | time-series, 시계열, timescaledb, prometheus, arima, lightgbm, pandas, bigquery, data-analysis, 데이터분석 | 5 | 2026-04-30 |
