...
related: [[kafka]], [[redis]], [[append-only-log]], [[mate-chat]]
source_count: 0
created: 2026-04-28
updated: 2026-04-28
---
...
본 페이지는 **stub** — 16회차 [[kafka]] / 24회차 [[mate-chat]] WebSocket Pub/Sub 등에서 인용되므로 정합성 stub.

## 핵심 패턴 3가지

| 패턴 | 설명 | 본 위키 사례 |
|---|---|---|
| **Event Notification** | "X가 일어났다" 단순 알림 | [[mate-chat]] FCM 푸시 / Sentry 알림 |
...
- 24회차 [[mate-chat]]: WebSocket Pub/Sub (Redis 기반) — 실시간 채팅 메시지 브로드캐스트
