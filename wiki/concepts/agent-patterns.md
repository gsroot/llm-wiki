...
type: concept
category: ai
tags: [agent-patterns, building-effective-agents, anthropic, prompt-chaining, routing, parallelization, orchestrator-workers, evaluator-optimizer, agent, workflow, spec-kit, sdd, pre-composed-patterns, openai, openai-cookbook, agents-sdk, exec-plans]
related: [[claude-code]], [[claude-agent-sdk]], [[anthropic]], [[autonomous-research-loop]], [[harness]], [[anthropics-claude-cookbooks]], [[mcp]], [[spec-kit]], [[spec-driven-development]], [[github]], [[openai]], [[openai-cookbook]]
source_count: 3
created: 2026-04-27
updated: 2026-04-27
---
