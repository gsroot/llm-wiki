...
본 페이지는 **stub** — [[dataframe-ecosystem-evolution]] 등에서 데이터 인프라 진화 맥락으로 인용되므로 정합성 stub.
...
- [[parquet]] / [[pyarrow]]: lakehouse 포맷의 공통 저장 표준
- [[duckdb]]: Iceberg 직접 읽기 지원 (DuckDB 1.0+)
- [[polars]]: Delta Lake 통합
...
- stub 사유: 점검에서 `[[lakehouse]]` 깨진 링크 발견. 기존 source 기반으로 1차 보강했지만, Delta Lake / Iceberg / Hudi 직접 source는 아직 미수집.
